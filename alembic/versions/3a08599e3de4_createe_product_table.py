...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("type", sa.String(), nullable=True, default="simple"),
        sa.Column("status", sa.String(), nullable=True, default="publish"),
        sa.Column("featured", sa.Boolean(), nullable=True, default=False),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("sku", sa.String(), nullable=True),
        sa.Column("price", sa.String(), nullable=True, default=0),
        sa.Column("purchase_price", sa.String(), nullable=True, default=0),
        sa.Column("regular_price", sa.String(), nullable=True, default=0),
